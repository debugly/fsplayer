...
#ifndef FSSDL__IJKSDL_AOUT_H
#define FSSDL__IJKSDL_AOUT_H
...
struct SDL_Aout {
    ...
    void   (*func_set_automatically_setup_audio_session)(SDL_Aout *aout, bool automaticallySetupAudioSession);
    // Android only
