...
#define FFP_MSG_VIDEO_ROTATION_CHANGED      404     /* arg1 = degree,deprecated from 1.0.2 */
...
#define FFP_MSG_SELECTING_STREAM_FAILED     851     /* select stream failed */
...
#define FFP_PROP_INT64_CHANNEL_CONFIG                   30000
