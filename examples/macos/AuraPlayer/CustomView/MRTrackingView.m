...
- (void)updateTrackingAreas
{
    ...
    if (hovered) {
        hovered = NO;
        if (self.delegate && [self.delegate respondsToSelector:@selector(trackingView:mouseExited:)]) {
            [self.delegate trackingView:self mouseExited:nil];
        }
    }
...
- (void)mouseEntered:(NSEvent *)theEvent
{
    ...
    hovered = YES;
    if (self.delegate && [self.delegate respondsToSelector:@selector(trackingView:mouseEntered:)]) {
        [self.delegate trackingView:self mouseEntered:theEvent];
    }
}
...
- (void)mouseExited:(NSEvent *)theEvent
{
    ...
    hovered = NO;
    if (self.delegate && [self.delegate respondsToSelector:@selector(trackingView:mouseExited:)]) {
        [self.delegate trackingView:self mouseExited:theEvent];
    }
}
...
- (void)mouseMoved:(NSEvent *)theEvent
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(trackingView:mouseMoved:)]) {
        [self.delegate trackingView:self mouseMoved:theEvent];
    }
}
...
- (void)mouseDown:(NSEvent *)theEvent
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(trackingView:mouseDown:)]) {
        [self.delegate trackingView:self mouseDown:theEvent];
    }
...
- (void)mouseUp:(NSEvent *)theEvent
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(trackingView:mouseUp:)]) {
        [self.delegate trackingView:self mouseUp:theEvent];
    }
}
...
- (void)mouseDragged:(NSEvent *)theEvent
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(trackingView:mouseDragged:)]) {
        [self.delegate trackingView:self mouseDragged:theEvent];
    }
}
...
- (void)cursorUpdate:(NSEvent *)event
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(trackingView:cursorNeedUpdate:)]) {
        if (![self.delegate trackingView:self cursorNeedUpdate:event]) {
            return;
        }
    }
