...
@implementation FSDemoHistoryItem
...
@interface FSDemoHistory ()

@end

@implementation FSDemoHistory {
    NSMutableArray *_list;
}

+ (instancetype)instance {
    static FSDemoHistory *s_obj = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        s_obj = [[FSDemoHistory alloc] init];
    });
...
- (void)add:(FSDemoHistoryItem *)item {
    __block NSUInteger findIdx = NSNotFound;
    
    [_list enumerateObjectsUsingBlock:^(FSDemoHistoryItem *enumItem, NSUInteger idx, BOOL *stop) {
