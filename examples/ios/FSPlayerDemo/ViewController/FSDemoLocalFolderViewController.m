...
@interface FSDemoLocalFolderViewController ()

@end

@implementation FSDemoLocalFolderViewController {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.section) {
        case 0: {
            ...
            FSDemoLocalFolderViewController *viewController = [[FSDemoLocalFolderViewController alloc] initWithFolderPath:fileName];
